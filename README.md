...
- **[Interlocutor](https://github.com/Slava-inc/Interlocutor)**  
...
Проекты, связанные с парсингом данных из различных источников.

- **[auto_ria_parser](https://github.com/Slava-inc/auto_ria_parser)**  
  Парсер автомобилей с сайта riaauto.ru с возможностью выбора категории и экспорта в Excel.

---

## 5. 🧩 Прочие проекты

Разные проекты, не отнесенные к предыдущим разделам.

- **[match_tool](https://github.com/Slava-inc/match-tool)**  
